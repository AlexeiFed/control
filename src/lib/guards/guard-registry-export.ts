...
export function buildGuardRegistryExportRow(guard: GuardListRow, index: number): GuardRegistryExportRow {
  ...
  return [
    ...
    guard.tshirtIssued ? "да" : "нет",
    guard.tshirtIssued && guard.tshirtSize != null ? formatUniformSizeDisplay(guard.tshirtSize) : "",
    guard.tshirtIssued ? formatOptionalDate(guard.tshirtIssuedOn) : "",
